...
$sql = "SELECT * FROM vendeur WHERE id = $id_vendeur";
...
<body class="bg-gray-100">
    <div class="container mx-auto mt-8">
        <h1 class="text-3xl font-semibold mb-8 text-center">Vendeur Profile</h1>
        <?php
    ...
    <form action="update_profile1.php" method="POST" class="bg-white p-8 rounded-lg shadow-md">
        <div class="mb-4">
